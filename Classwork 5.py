...
# ________Get min
     def getMin(self):
          if self.start_node is None:
               return 0
          n = self.start_node
        # This is where finding the minmum is  
          min = n.item
          while n is not None:
               if n.item < min:
                    min = n.item
...
while choice != 10:
    ...
    print(" 10 = Exit")
    print("11 = sum up the items in the linked list")
    print("12 = find the lowest value of the linked list")
    print("13 = find the biggest value of the linked list")
    print("14 = average out the numbers in the list")
    choice = int(input("\n Enter Choice: "))
